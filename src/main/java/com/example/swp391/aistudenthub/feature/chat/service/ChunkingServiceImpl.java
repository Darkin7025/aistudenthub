...
/**
 * Implementation của ChunkingService.
 * Chia văn bản thành chunks với các strategy khác nhau.
 */
@Slf4j
@Service
public class ChunkingServiceImpl implements ChunkingService {
    ...
    // Pattern để tách câu (sentence boundary)
    ...
    // Pattern để tách đoạn văn (paragraph)
    ...
    /**
     * Chia theo fixed size với overlap.
     * Strategy tốt nhất cho RAG vì đảm bảo context không bị mất.
     */
    private List<TextChunk> chunkByFixedSize(String text) {
        ...
        while (start < words.length) {
            ...
            // Tìm sentence boundary gần end để không cắt giữa câu
            if (end < words.length) {
    ...
    /**
     * Tìm sentence boundary gần position.
     */
    private int findSentenceBoundary(String[] words, int position) {
        // Search forward trong window 50 words
        ...
        // Search backward nếu không tìm thấy
    ...
    /**
     * Chia theo sentence.
     * Phù hợp cho văn bản ngắn hoặc Q&A.
     */
    private List<TextChunk> chunkBySentence(String text) {
        ...
        for (String sentence : sentences) {
            ...
            // Nếu thêm câu này vào chunk hiện tại vượt quá limit
